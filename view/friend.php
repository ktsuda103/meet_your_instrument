            ...
            <main>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 pl-0">
                        ...
                        <?php if(!empty($message['delete_friend'])): ?>
                            <div class="alert alert-success" role="alert">
                                <?php echo $message['delete_friend']; ?>
                            </div>
                        <?php endif; ?>
                        <div class="container">
                            <div class="row">
                            <?php if(!empty($friends)): ?>
                                ...
                                <div class="card col-md-4">
                                    <div class="card-header">
                                        <?php echo h($friend['user_id']); ?>
                                        <form method="post" class="d-inline">
                                            <input type="hidden" name="process_kind" value="delete_friend">
                                            <input type="hidden" name="friend_id" value="<?php echo h($friend['friend_id']); ?>">
                                            <input type="submit" value="&#xf1f8;" class="fas icon">
                                        </form>
                                        
                                    </div>
                                    <div class="card-body">
                                        <img src="./img/<?php echo h($friend['img']); ?>" class="img-fluid item-image">
                                    </div>
                                    <div class="card-footer">
                                    <a href="./message.php?id=<?php echo h($friend['id']); ?>" class="btn btn-primary mr-2"><i class="fas fa-envelope-open"></i>メッセージを送る</a>
