                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <?php foreach($histories as $history): ?>
                                    <img src="./img/<?php echo h($history['img']); ?>" class="img-fluid col-md-2 item-image">
                                    <span class="col-6"><?php echo h($history['name']); ?></span>
                                      
                                    <span class="col-md-2">¥<?php echo number_format(h($history['price'])); ?></span>
                                    <span class="col-md-2"><?php echo h($history['created_at']); ?></span>
                                <?php endforeach; ?>
                            </div>
                        </div>
                    </div>
